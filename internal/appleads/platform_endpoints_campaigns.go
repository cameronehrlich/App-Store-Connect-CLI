...
func platformCampaignEndpointSpecs() []EndpointSpec {
	...
	return []EndpointSpec{
		...
		platform("platform-update-ad-group", http.MethodPut, "v1/adgroups/{id}", []string{"ad-groups", "update"}, ContextAdAccount, BodyObject, false, "AdGroupUpdate", "AdGroupResponse", []ParamSpec{adGroupID}, nil),

		platform("platform-create-ad", http.MethodPost, "v1/ads", []string{"ads", "create"}, ContextAdAccount, BodyObject, false, "AdCreate", "AdResponse", nil, nil),
		...
		platform("platform-update-shared-budget", http.MethodPut, "v1/shared-budgets/{id}", []string{"budget-orders", "update"}, ContextNone, BodyObject, false, "SharedBudgetUpdate", "SharedBudgetResponse", []ParamSpec{sharedBudgetID}, nil),

		platform("platform-bulk-create-keywords", http.MethodPost, "v1/keywords/bulk-create", []string{"targeting-keywords", "create-bulk"}, ContextAdAccount, BodyObject, false, "KeywordCreateBulkRequest", "KeywordCreateBulkResponse", nil, nil),
		platform("platform-bulk-update-keywords", http.MethodPost, "v1/keywords/bulk-update", []string{"targeting-keywords", "update-bulk"}, ContextAdAccount, BodyObject, false, "KeywordUpdateBulkRequest", "KeywordUpdateBulkResponse", nil, nil),
		...
		platform("platform-update-campaign", http.MethodPut, "v1/campaigns/{id}", []string{"campaigns", "update"}, ContextAdAccount, BodyObject, false, "CampaignUpdate", "CampaignResponse", []ParamSpec{campaignID}, nil),
