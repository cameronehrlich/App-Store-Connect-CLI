...
func TestAdsGuideExamplesDispatchRepresentativeCommands(t *testing.T) {
	...
	expectedWarnings := map[string]string{
		...
		`asc ads v5 targeting-keywords create-bulk --org "123456" --campaign 987654321 --ad-group 123456789 --file keywords.json`:              adsV5ReplacementWarning("v5 targeting-keywords create-bulk", "targeting-keywords create-bulk"),
